/* eslint-disable */
// @ts-nocheck
// Vendored from qrcode.react v4.2.0 — ISC License, Copyright (c) 2015 Paul O'Shannessy.
// Vendored (instead of an npm dependency) so the production build needs no extra install step.
